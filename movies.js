    ...
    },  
{
  ...
  lines: [""],
  hints: ["./vids/losthorizon.mp4", "./pics/losthorizon.jpg"],
  pics: [],
  videos: [''],
  audios: [""],
  ...
  lines: [""],
  hints: ["./pics/baby.png", "./pics/baby2.png", "./pics/baby3.png"],
  pics: [],
  videos: [''],
  audios: [""],
  syn: "mild mannered paleontology professor Dr. David Huxley is excited by the news that an intercostal clavicle bone has been found to complete his brontosaurus skeleton, a project four years in the construction. He is equally excited about his imminent marriage to his assistant, the officious Alice Swallow, who is interested in him more for his work than for him as a person. David needs the $1 million endowment of wealthy dowager Mrs. Carleton Random to complete the project. Her lawyer, Alexander Peabody, will make the decision on her behalf, so David needs to get in his favor. However, whenever David tries to make a good impression on Peabody, the same young woman always seems to do something to make him look bad. She is the flighty heiress Susan Vance.",
  links: ["https://www.imdb.com/title/tt0029947/?ref_=nv_sr_srsg_0"],
  oscar: ""
  },
  {
  year: 1938,
  ...
  init: "TLV",
  director: "Alfred Hitchcock",
  stars: ["Margaret Lockwood", "Michael Redgrave", "May Whitty", "Paul Lukas"],
  lines: [""],
  hints: ["Co-stars a member of a famous acting family", "./auds/ladyvanishes.m4a", "./vids/ladyvanishes.mp4"],
  pics: [],
  videos: [''],
  audios: [""],
...
init: "BG",
director: "William Wellman",
stars: ["Gary Cooper", "Ray Milland", "Brian Donlevy", "Susan Hayward"],
lines: [""],
hints: ["a valuable sapphire","./pics/beau.png", "./vids/beau.mp4"],
pics: [],
videos: [''],
audios: [""],
...
stars: ["James Stewart", "Marlene Dietrich", "Mischa Auer", "Brian Donlevy"],
lines: [""],
hints: ["A 1939 classic Western","./pics/destry.png", "./vids/destry.mp4"],
pics: [],
videos: [''],
audios: [""],
...
init: "DATM",
director: "John Ford",
stars: ["Henry Fonda", "Claudette Colbert", "Edna May Oliver"],
lines: [""],
hints: ["Revolutionary War frontier", "./vids/drums.mp4", "./pics/drums.png"],
pics: [],
videos: [''],
audios: [""],
...
lines: [""],
hints: ["Brits in North Africa","./pics/feathers.png", "./vids/feathers.mp4"],
pics: [],
videos: [''],
audios: [""],
...
stars: ["Cary Grant", "Victor McLaglen", "Douglas Fairbanks Jr.", "Sam Jaffe"],
lines: [""],
hints: ["Brits in India","./pics/gunga.png", "./vids/gunga.mp4"],
pics: [],
videos: [''],
audios: [""],
